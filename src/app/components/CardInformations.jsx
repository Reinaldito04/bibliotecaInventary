...
const endpointConfig = [
  { key: "cantidadLibros", url: "/information/getBooksCantity", title: "Libros Registrados", icon: <FaBook />, description: "Libros en el sistema" },
  { key: "cantidadMultas", url: "/information/getFinesCantity", title: "Multas Registradas", icon: <FaMoneyBillWave />, description: "Multas activas" },
  { key: "cantidadReservas", url: "/information/getReservesCantity", title: "Reservas Registradas", icon: <FaCalendarCheck />, description: "Reservas totales" },
  { key: "cantidadPrestamos", url: "/information/getLeans", title: "Préstamos Activos", icon: <FaBookOpen />, description: "Préstamos en curso" },
  ...
  { key: "cantidadUsers", url: "/information/getCantityUsers", title: "Usuarios Registrados", icon: <FaUser />, description: "Usuarios totales" },
];
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {endpointConfig.map(({ key, title, icon, description }) => (
        <div key={key} className="bg-gradient-to-b from-gray-100 to-white rounded-2xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-transform p-6 flex flex-col items-center text-center space-y-4">
          ...
          <p className="text-5xl font-extrabold text-blue-600">{loading ? "..." : data[key]}</p>
