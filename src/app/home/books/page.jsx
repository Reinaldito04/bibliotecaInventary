  ...
  return (
    <UserLayout>
      ...
      <div className="container mx-auto px-6 py-8 bg-gray-50 ">
        <h1 className="text-3xl font-bold text-center mb-6 text-black-600">Búsqueda de Libros</h1>
        <div className="mb-6">
          <input
            type="text"
            value={searchTerm}
              ...
              {filteredResults.map((book, index) => (
                ...
                >
                  <div className="flex flex-col gap-2 ">
                    <h3 className="text-2xl font-semibold text-blue-600">{book.Titulo}</h3>
                    <p className="text-gray-700 text-lg">Autor: {book.Autor}</p>
                    <p className="text-gray-600">Editorial: {book.Editorial}</p>
                  </div>
                  <div className="flex justify-between items-center">
                    <p className="text-gray-600">Cantidad disponible: {book.cantidad_disponible}</p>
                    <button className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-6 rounded-md transition-all
                    duration-300
                    ease-in-out
